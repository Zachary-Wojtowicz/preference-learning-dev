...
| 2 | 0.05 | 0.75 | 0 | -0.6285 | +0.0637 | 0.675 | -0.037 |
| 3 | 0.05 | 1.25 | 0 | -0.6285 | +0.0637 | 0.675 | -0.037 |
| 4 | 0.05 | 1 | 0 | -0.6285 | +0.0637 | 0.675 | -0.037 |
| 5 | 0.05 | 1.5 | 0 | -0.6285 | +0.0637 | 0.675 | -0.037 |
| 6 | 0.05 | 0.5 | 0.25 | -0.6308 | +0.0613 | 0.675 | -0.037 |
| 7 | 0.05 | 0.75 | 0.25 | -0.6311 | +0.0611 | 0.675 | -0.037 |
| 8 | 0.05 | 1 | 0.25 | -0.6318 | +0.0603 | 0.688 | -0.025 |
| 9 | 0.05 | 1.25 | 0.25 | -0.6331 | +0.0590 | 0.688 | -0.025 |
| 10 | 0.05 | 0.5 | 0.5 | -0.6342 | +0.0579 | 0.688 | -0.025 |
...
| 2 | 0.05 | 0.75 | 0 | -0.6414 | +0.0509 | 0.673 | +0.018 |
| 3 | 0.05 | 1.25 | 0 | -0.6414 | +0.0509 | 0.673 | +0.018 |
| 4 | 0.05 | 1.5 | 0 | -0.6414 | +0.0509 | 0.673 | +0.018 |
| 5 | 0.05 | 1 | 0 | -0.6414 | +0.0509 | 0.673 | +0.018 |
| 6 | 0.05 | 0.5 | 0.25 | -0.6426 | +0.0497 | 0.670 | +0.015 |
| 7 | 0.05 | 0.75 | 0.25 | -0.6431 | +0.0492 | 0.670 | +0.015 |
| 8 | 0.05 | 1 | 0.25 | -0.6437 | +0.0486 | 0.672 | +0.017 |
| 9 | 0.05 | 0.5 | 0.5 | -0.6440 | +0.0483 | 0.676 | +0.021 |
| 10 | 0.05 | 1.25 | 0.25 | -0.6446 | +0.0478 | 0.672 | +0.017 |
...
### inference_affirm
  ...
  - Best α>0:   λ=0.05, scale=0.5, α=0.25 → LL = -0.6308, acc = 0.675
  - **Δ LL (best feedback − best no-feedback): -0.0024** (feedback hurts or no help)

### inference_categories

  - Best α=0:   λ=0.05, scale=0.5 → LL = -0.6414, acc = 0.673
  - Best α>0:   λ=0.05, scale=0.5, α=0.25 → LL = -0.6426, acc = 0.670
  - **Δ LL (best feedback − best no-feedback): -0.0012** (feedback hurts or no help)
