...
| inference_affirm | 0.619 | 0.221 | 72% |
| inference_categories | 0.873 | 0.111 | 100% |
...
| inference_affirm | projection_alpha | 0.296 | 0.326 | 1.000 | -0.026 |
...
| inference_categories | projection_alpha | 0.786 | 0.438 | 1.000 | 0.331 |
...
| inference_affirm | 0.500 | 0.526 | 0.537 | +0.037 |
| inference_categories | 0.493 | 0.522 | 0.584 | +0.091 |
...
| inference_affirm | -0.6972 | -0.9115 | -0.6915 | +0.0057 |
| inference_categories | -0.6953 | -0.9101 | -0.6862 | +0.0091 |
...
| inference_affirm vs 0.5 | 100 | 0.619 | 0.0000 |
| inference_categories vs 0.5 | 100 | 0.873 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.042 | 0.2258 |
| inference_categories vs choice_only | 100 | Δ=+0.297 | 0.0000 |
...
| inference_affirm | projection_alpha | 0.502 | 0.532 | 0.573 | 0.551 | 0.537 |
...
| inference_categories | projection_alpha | 0.500 | 0.551 | 0.588 | 0.601 | 0.584 |

**⚠ Non-monotonic learning detected (acc didn't improve from mid-T to end-T):**

- inference_affirm/projection_alpha: T=12→0.568, T=20→0.537
- inference_categories/random_projection: T=12→0.509, T=20→0.493
- inference_categories/projection_only: T=12→0.533, T=20→0.521

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 59% · inference_affirm: 72% · inference_categories: 100%
