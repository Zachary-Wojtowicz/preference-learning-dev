...
| inference_affirm | 0.574 | 0.236 | 64% |
| inference_categories | 0.710 | 0.195 | 85% |
...
| inference_affirm | projection_alpha | 0.243 | 0.307 | 1.000 | -0.072 |
...
| inference_categories | projection_alpha | 0.451 | 0.354 | 1.000 | 0.080 |
...
| inference_affirm | 0.500 | 0.526 | 0.541 | +0.041 |
| inference_categories | 0.493 | 0.522 | 0.540 | +0.047 |
...
| inference_affirm | -0.6972 | -0.9115 | -0.6901 | +0.0072 |
| inference_categories | -0.6953 | -0.9101 | -0.6823 | +0.0130 |
...
| inference_affirm vs 0.5 | 100 | 0.574 | 0.0028 |
| inference_categories vs 0.5 | 100 | 0.710 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=-0.003 | 0.8662 |
| inference_categories vs choice_only | 100 | Δ=+0.133 | 0.0001 |
...
| inference_affirm | projection_alpha | 0.478 | 0.509 | 0.548 | 0.541 | 0.541 |
...
| inference_categories | projection_alpha | 0.543 | 0.517 | 0.555 | 0.554 | 0.540 |

**⚠ Non-monotonic learning detected (acc didn't improve from mid-T to end-T):**

- inference_affirm/projection_alpha: T=12→0.560, T=20→0.541
- inference_categories/random_projection: T=12→0.509, T=20→0.493
- inference_categories/projection_only: T=12→0.533, T=20→0.521
- inference_categories/projection_alpha: T=12→0.552, T=20→0.540

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 59% · inference_affirm: 64% · inference_categories: 85%
