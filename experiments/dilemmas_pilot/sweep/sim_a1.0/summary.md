...
| inference_affirm | 0.582 | 0.236 | 63% |
| inference_categories | 0.764 | 0.165 | 92% |
...
| inference_affirm | projection_alpha | 0.251 | 0.313 | 1.000 | -0.062 |
...
| inference_categories | projection_alpha | 0.537 | 0.380 | 1.000 | 0.148 |
...
| inference_affirm | 0.500 | 0.526 | 0.538 | +0.038 |
| inference_categories | 0.493 | 0.522 | 0.549 | +0.056 |
...
| inference_affirm | -0.6972 | -0.9115 | -0.6895 | +0.0077 |
| inference_categories | -0.6953 | -0.9101 | -0.6827 | +0.0126 |
...
| inference_affirm vs 0.5 | 100 | 0.582 | 0.0009 |
| inference_categories vs 0.5 | 100 | 0.764 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.006 | 0.9561 |
| inference_categories vs choice_only | 100 | Δ=+0.188 | 0.0000 |
...
| inference_affirm | projection_alpha | 0.483 | 0.511 | 0.551 | 0.541 | 0.538 |
...
| inference_categories | projection_alpha | 0.533 | 0.541 | 0.561 | 0.555 | 0.549 |

**⚠ Non-monotonic learning detected (acc didn't improve from mid-T to end-T):**

- inference_affirm/projection_alpha: T=12→0.560, T=20→0.538
- inference_categories/random_projection: T=12→0.509, T=20→0.493
- inference_categories/projection_only: T=12→0.533, T=20→0.521
- inference_categories/projection_alpha: T=12→0.562, T=20→0.549

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 59% · inference_affirm: 63% · inference_categories: 92%
