...
| inference_affirm | 0.592 | 0.229 | 66% |
| inference_categories | 0.826 | 0.132 | 99% |
...
| inference_affirm | projection_alpha | 0.263 | 0.316 | 1.000 | -0.052 |
...
| inference_categories | projection_alpha | 0.663 | 0.407 | 1.000 | 0.239 |
...
| inference_affirm | 0.500 | 0.526 | 0.539 | +0.039 |
| inference_categories | 0.493 | 0.522 | 0.568 | +0.075 |
...
| inference_affirm | -0.6972 | -0.9115 | -0.6904 | +0.0069 |
| inference_categories | -0.6953 | -0.9101 | -0.6844 | +0.0110 |
...
| inference_affirm vs 0.5 | 100 | 0.592 | 0.0002 |
| inference_categories vs 0.5 | 100 | 0.826 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.016 | 0.7104 |
| inference_categories vs choice_only | 100 | Δ=+0.249 | 0.0000 |
...
| inference_affirm | projection_alpha | 0.488 | 0.525 | 0.561 | 0.545 | 0.539 |
...
| inference_categories | projection_alpha | 0.514 | 0.538 | 0.577 | 0.573 | 0.568 |

**⚠ Non-monotonic learning detected (acc didn't improve from mid-T to end-T):**

- inference_affirm/projection_alpha: T=12→0.562, T=20→0.539
- inference_categories/random_projection: T=12→0.509, T=20→0.493
- inference_categories/projection_only: T=12→0.533, T=20→0.521
- inference_categories/projection_alpha: T=12→0.571, T=20→0.568

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 59% · inference_affirm: 66% · inference_categories: 99%
