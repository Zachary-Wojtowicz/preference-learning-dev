...
| inference_categories | 0.662 | 0.199 | 80% |
...
| inference_categories | projection_alpha | 0.410 | 0.234 | 1.000 | -0.061 |
...
| inference_categories | 0.576 | 0.679 | 0.679 | +0.104 |
...
| inference_categories | -0.6915 | -0.5812 | -0.5812 | +0.1103 |
...
| inference_categories vs 0.5 | 100 | 0.662 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.041 | 0.2847 |
| inference_categories vs choice_only | 100 | Δ=+0.027 | 0.5072 |
...
| inference_categories | projection_alpha | 0.542 | 0.632 | 0.668 | 0.664 | 0.679 |
...
- Predicted win rate (other > standard) — choice_only: 72% · inference_affirm: 76% · inference_categories: 80%
