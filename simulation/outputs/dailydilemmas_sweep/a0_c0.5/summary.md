...
| inference_affirm | 0.651 | 0.220 | 76% |
| inference_categories | 0.718 | 0.179 | 86% |
...
| inference_affirm | projection_alpha | 0.384 | 0.228 | 1.000 | -0.080 |
...
| inference_categories | projection_alpha | 0.525 | 0.241 | 1.000 | 0.004 |
...
| inference_affirm | 0.575 | 0.663 | 0.663 | +0.089 |
| inference_categories | 0.576 | 0.679 | 0.680 | +0.105 |
...
| inference_affirm | -0.6914 | -0.6028 | -0.6028 | +0.0885 |
| inference_categories | -0.6915 | -0.5812 | -0.6667 | +0.0248 |
...
| inference_affirm vs 0.5 | 100 | 0.651 | 0.0000 |
| inference_categories vs 0.5 | 100 | 0.718 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.016 | 0.7508 |
| inference_categories vs choice_only | 100 | Δ=+0.084 | 0.0018 |
...
| inference_affirm | projection_alpha | 0.556 | 0.593 | 0.625 | 0.645 | 0.663 |
...
| inference_categories | projection_alpha | 0.574 | 0.670 | 0.677 | 0.672 | 0.680 |
...
- inference_categories/projection_alpha: T=12→0.684, T=20→0.680

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 72% · inference_affirm: 76% · inference_categories: 86%
