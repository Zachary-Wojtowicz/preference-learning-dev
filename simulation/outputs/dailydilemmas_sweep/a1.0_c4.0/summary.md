...
| inference_affirm | 0.700 | 0.188 | 79% |
| inference_categories | 0.827 | 0.127 | 99% |
...
| inference_affirm | projection_alpha | 0.476 | 0.240 | 1.000 | -0.022 |
...
| inference_categories | projection_alpha | 0.753 | 0.266 | 1.000 | 0.142 |
...
| inference_affirm | 0.575 | 0.663 | 0.673 | +0.098 |
| inference_categories | 0.576 | 0.679 | 0.717 | +0.141 |
...
| inference_affirm | -0.6914 | -0.6028 | -0.6791 | +0.0123 |
| inference_categories | -0.6915 | -0.5812 | -0.6868 | +0.0047 |
...
| inference_affirm vs 0.5 | 100 | 0.700 | 0.0000 |
| inference_categories vs 0.5 | 100 | 0.827 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.065 | 0.0549 |
| inference_categories vs choice_only | 100 | Δ=+0.192 | 0.0000 |
...
| inference_affirm | projection_alpha | 0.614 | 0.622 | 0.628 | 0.653 | 0.673 |
...
| inference_categories | projection_alpha | 0.602 | 0.714 | 0.719 | 0.713 | 0.717 |
...
- inference_categories/projection_alpha: T=12→0.727, T=20→0.717

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 72% · inference_affirm: 79% · inference_categories: 99%
