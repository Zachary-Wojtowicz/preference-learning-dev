...
| inference_categories | 0.766 | 0.161 | 94% |
...
| inference_categories | 0.576 | 0.679 | 0.690 | +0.114 |
...
| inference_categories | -0.6915 | -0.5812 | -0.6771 | +0.0144 |
...
| inference_categories vs 0.5 | 100 | 0.766 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.016 | 0.7508 |
| inference_categories vs choice_only | 100 | Δ=+0.132 | 0.0000 |
...
| inference_categories | projection_alpha | 0.593 | 0.685 | 0.688 | 0.682 | 0.690 |
...
- inference_categories/projection_alpha: T=12→0.693, T=20→0.690

## Go/No-Go Read

- Predicted win rate (other > standard) — choice_only: 72% · inference_affirm: 76% · inference_categories: 94%
