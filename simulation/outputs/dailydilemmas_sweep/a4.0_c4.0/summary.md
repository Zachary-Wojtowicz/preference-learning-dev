...
| inference_affirm | 0.782 | 0.147 | 95% |
...
| inference_affirm | projection_alpha | 0.640 | 0.257 | 1.000 | 0.077 |
...
| inference_affirm | 0.575 | 0.663 | 0.680 | +0.105 |
...
| inference_affirm | -0.6914 | -0.6028 | -0.6881 | +0.0033 |
...
| inference_affirm vs 0.5 | 100 | 0.782 | 0.0000 |
| inference_categories vs 0.5 | 100 | 0.827 | 0.0000 |
| inference_affirm vs choice_only | 100 | Δ=+0.147 | 0.0000 |
...
| inference_affirm | projection_alpha | 0.604 | 0.629 | 0.644 | 0.670 | 0.680 |
...
- Predicted win rate (other > standard) — choice_only: 72% · inference_affirm: 95% · inference_categories: 99%
